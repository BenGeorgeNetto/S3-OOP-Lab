...
1. [Palindrome](src/Palindrome.java)
2. [Character Frequency](src/CharFrequency.java)
...
10. [Exception Handling](src/Calculator.java)
11. [Multi-Threading](src/MultiThreadingTest.java)
